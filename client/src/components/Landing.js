        ...
        <div className="article_content">
          <p>
            ...
            <ul>
              <li>
                {" "}
                Kirk will bring up muliple results, namely the famous James T. Kirk, his father
                George and Mother Winona.
              </li>
              <li>
                Crusher will result in Dr. Beverly Crusher from the Enterprise-D, and her son
                Wesley, and husband Jack.
              </li>
              <li>
